...
function entryManifest(entry: JsonObject): EntryClientManifest {
...
export function readOnlyPresentationStores(presentation: JsonObject | null | undefined): readonly EntryStateStore[] {
