...
export { builtInActionPresentation, builtInActionTranslationKeys, type BuiltInActionPresentation } from './presentation'
export type {
  ActionContract,
  ActionContext,
  ...
  ActionModalOptions,
  ActionModalWidth,
  ActionReadOnlyEntryManifest,
  ActionReadOnlyInfolistManifest,
  ActionReadOnlyPresentationManifest,
