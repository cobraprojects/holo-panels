...
const operationMap = Object.freeze({
  ...
  belongsToMany: ['list', 'view', 'attach', 'detach', 'create', 'edit', 'delete', 'editPivot'] as const,
  ...
  morphToMany: ['list', 'view', 'attach', 'detach', 'create', 'edit', 'delete', 'editPivot'] as const,
  morphedByMany: ['list', 'view', 'attach', 'detach', 'create', 'edit', 'delete', 'editPivot'] as const,
