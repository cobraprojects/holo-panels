...
function ResourceForm({ data, operation, pageOperation, panelId, registry, resource }: {
  readonly data: JsonObject
  readonly operation: NextResourceOperationTransport
...
function ResourceView({ basePath, data, operation, panelId, registry, resource }: {
  readonly basePath: string
  readonly data: JsonObject
  readonly operation: NextResourceOperationTransport
  readonly panelId: string
...
export function NextPanelResourcePage({ data, effects, operation: operationInput, panelId, panelPath, properties, registry: registryInput }: {
  readonly data: JsonObject
  ...
  if (pageOperation === 'create' || pageOperation === 'edit') return <ResourceForm data={data} operation={operation} pageOperation={pageOperation} panelId={panelId} registry={registry} resource={resource} />
  return <ResourceView basePath={basePath} data={data} operation={operation} panelId={panelId} registry={registry} resource={resource} />
}
