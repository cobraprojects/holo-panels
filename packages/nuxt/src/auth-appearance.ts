import { panelThemeVariables } from '@holo-js/panels-vue'

export interface NuxtPanelAuthAppearance {
...
export function nuxtPanelAuthAppearanceVariables(
  appearance?: NuxtPanelAuthAppearance,
