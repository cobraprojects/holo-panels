    ...
    return () => {
      ...
      const card = h(Card, { class: 'hp-auth-card' }, () => [
        ...
        h(CardContent, {}, () => h(FieldGroup, {}, () => [
          ...
          recoveryCodes.value.length ? h(Card, {}, () => [h(CardHeader, {}, () => h(CardTitle, {}, () => 'Recovery codes')), h(CardContent, {}, () => h('ul', recoveryCodes.value.map(value => h('li', { key: value }, [h('code', value)]))))]) : null,
