...
{#snippet surface()}
  ...
  <Dialog.Content aria-labelledby={labelledBy} aria-modal="true" class="hp-modal" data-holo-panel="" data-panels-component="modal" data-slot="dialog-content" role="dialog">
