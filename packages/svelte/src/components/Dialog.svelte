...
{#if open}
  <div aria-labelledby={labelledBy} aria-modal="true" bind:this={surface} class="hp-modal" data-panels-component="modal" onkeydown={onkeydown} role="dialog" tabindex="-1">{@render children?.()}</div>
{/if}
