<script lang="ts" module>
	...
	export const inputGroupAddonVariants = tv({
		...
		variants: {
			align: {
				"inline-start": "hp:pl-2 hp:has-[>button]:ml-[-0.3rem] hp:has-[>kbd]:ml-[-0.15rem] hp:order-first",
				"inline-end": "hp:pr-2 hp:has-[>button]:mr-[-0.3rem] hp:has-[>kbd]:mr-[-0.15rem] hp:order-last",
