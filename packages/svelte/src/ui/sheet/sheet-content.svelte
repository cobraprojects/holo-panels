	...
	>
		...
		{#if showCloseButton}
			<SheetPrimitive.Close data-slot="sheet-close">
				{#snippet child({ props })}
					<Button variant="ghost" class="hp:absolute hp:top-3 hp:right-3" size="icon-sm" {...props}>
						<XIcon  />
