...
describe('P13 Svelte notification renderers', () => {
  ...
  it('renders an accessible persistent toast queue with close controls and safe actions', () => {
    ...
    expect(markup).toContain('data-slot="notification-toast"')
    expect(markup).toContain('data-slot="notification-toast-accent"')
    expect(markup).toContain('data-slot="notification-toast-content"')
    expect(markup).toContain('data-slot="notification-toast-actions"')
    expect(markup).toContain('hp-notification-toast-close')
    expect(markup).not.toContain('style="')
    expect(markup).toContain('href="/reports"')
    expect(markup).toContain('aria-label="Close Report ready"')
