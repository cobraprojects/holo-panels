...
export default defineConfig({
  resolve: {
    alias: [
      { find: '$app/navigation', replacement: fileURLToPath(new URL('./tests/sveltekit-navigation.ts', import.meta.url)) },
    ...
    projects: [
      ...
      },
      {
        ...
        test: {
          ...
          include: ['tests/auth-pages.test.ts', 'tests/login-page.test.ts'],
          name: 'auth-browser',
        },
      },
      {
