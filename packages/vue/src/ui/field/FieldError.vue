...
<template>
  <div
    ...
    :class="cn('hp:text-destructive hp:text-sm hp:font-normal', props.class)"
  >
    ...
    <ul v-else-if="Array.isArray(content)" class="hp:ms-4 hp:flex hp:list-disc hp:flex-col hp:gap-1">
