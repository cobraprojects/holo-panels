...
<template>
  <div
    ...
    :class="cn(
      ...
      'hp:has-[[data-slot=input-group-control]:focus-visible]:border-ring hp:has-[[data-slot=input-group-control]:focus-visible]:ring-3 hp:has-[[data-slot=input-group-control]:focus-visible]:ring-ring/50',
