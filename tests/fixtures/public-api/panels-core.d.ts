...
import { J as JsonObject, b as RenderSlotReference, a as JsonValue, c as TableQueryFilterDefinition, S as ScopedRenderSlots, P as PanelRenderSlot, R as ResourceRenderSlot, H as HoloTableQuery, d as TableQueryDefinition, T as TableQueryState, e as TableQueryResult, f as TableRecordIdentifier, g as TableSelection, h as JsonPrimitive, i as TableFilterOperator, j as TableQueryFilter } from './contracts-BH_vIAQL.js';
export { A as AllTableQueryResult, C as CursorTableQueryResult, k as HoloCursorPaginatedResult, l as HoloPaginatedResult, m as HoloPaginationMeta, n as HoloSimplePaginatedResult, o as HoloSimplePaginationMeta, p as JsonArray, q as PageTableQueryResult, r as RenderSlotSource, s as ScopedRenderSlotManifest, t as SimpleTableQueryResult, u as TableAggregateKind, v as TablePaginationMode, w as TableQueryAggregateDefinition, x as TableQueryColumnDefinition, y as TableQueryScalar, z as TableQuerySort, B as TableSortDirection } from './contracts-BH_vIAQL.js';
...
declare class ResourceBuilder<TModel extends {
    ...
    slot(slot: ResourceRenderSlot, reference: string | RenderSlotReference): this;
