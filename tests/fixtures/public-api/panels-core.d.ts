import { F as FieldClientHints, a as FormFieldPath, b as FormFieldValue, B as BoundFormField, c as FieldResolvable, d as FieldResolver, C as CompiledFieldDefinition, e as FieldResolverContext, f as FieldPresentationState, g as FormFieldPathFor, R as RecordPath, h as RelationPath, i as RelatedRecord, j as RecordPathValue, k as FilterIndicatorResolver, l as CompiledFilterDefinition, m as FilterServerHandles, n as FilterEncoder, o as FilterManifest, O as OptionValue, p as ChoiceOption, q as OptionSource, r as OptionQueryRequest, s as OptionPage, t as OptionServiceLimits, H as HoloOptionQuery, u as RelationshipOptionAdapter, v as RelationshipOptionQueryModifier, w as RelationOperation, N as NormalizedRelationListRequest, x as RelationRecordPage, y as RelationPresentation, z as RelationListRequest, A as RecordPathFor, D as ColumnResolver, E as ColumnAlignment, G as ColumnDataSource, T as TextFormatter, I as InlineEditorManifest, J as CompiledColumnDefinition, K as ColumnAggregate, L as AdvancedOperatorFor, M as AdvancedScalarType, P as AdvancedFilterColumn, Q as AdvancedColumnMap, S as AdvancedFilterValue, U as AdvancedFilterCondition, V as DateRangeFilterValue, W as SelectFilterOption, X as FilterExecutionContext, Y as TernaryFilterValue, Z as TrashedFilterValue, _ as FilterResponsiveColumns, $ as FilterCollectionPlacement, a0 as FilterCollectionPresentation, a1 as FilterIndicator, a2 as P7AFilterCompatibility } from './browser-CKIUTmmB.js';
export { a3 as AnyAdvancedFilterColumn, a4 as BuiltInActionPresentation, a5 as ColumnManifest, a6 as ColumnServerHandles, a7 as ErrorCategory, a8 as ErrorEnvelope, a9 as FieldLayout, aa as FieldOperation, ab as FieldStateCodec, ac as FilterLayout, ad as FilterMode, ae as FormValidationField, af as FormValues, ag as HoloOptionPage, ah as IDEMPOTENCY_HEADER, ai as InlineEditorKind, aj as ManifestSerializationError, ak as OptionDependencies, al as PROTOCOL_VERSION, am as PanelNotification, an as PanelNotificationAccessError, ao as PanelNotificationInbox, ap as PanelRecordTypeRegistry, aq as PanelRelationValue, ar as PanelRelationValueMarker, as as PanelsError, at as PanelsTransportError, au as ProtocolCompatibilityError, av as ProtocolVersion, aw as RegisteredPanelRecord, ax as RegisteredPanelRecordForPath, ay as RegisteredPanelRecordForPathValue, az as RegisteredPanelRecordPath, aA as RegisteredPanelRecordPathFor, aB as RelationListSort, aC as RelationshipOptionContext, aD as RequestEnvelope, aE as ResponseEnvelope, aF as SchemaTraversalContext, aG as SuccessEnvelope, aH as SupportedFilterOperator, aI as TRANSPORT_REQUEST_FIELD, aJ as TableWidgetExecutor, aK as TransportDecodedRequest, aL as TransportDecodingError, aM as TransportOperation, aN as TransportOperationKind, aO as TransportRequestOptions, aP as TransportServerRequestLike, aQ as TransportServerResult, aR as WidgetAccessError, aS as applySchemaManifestPatches, aT as applySchemaNodePatches, aU as arCatalog, aV as assertJsonSafe, aW as assertProtocolCompatible, aX as builtInActionPresentation, aY as builtInActionTranslationKeys, aZ as createAccessibleChartModel, a_ as createRequestEnvelope, a$ as databaseNotificationPayload, b0 as decodeRequestEnvelope, b1 as decodeResponseEnvelope, b2 as decodeTransportServerRequest, b3 as defineTransportOperation, b4 as dispatchPanelNotification, b5 as evaluateSchemaVisibility, b6 as findSchemaComponent, b7 as isPanelDatabaseNotificationPayload, b8 as isProtocolCompatible, b9 as normalizeTransportError, ba as notificationExecution, bb as notificationPresentation, bc as panelNotification, bd as parseProtocolVersion, be as patchSchemaManifestNode, bf as patchSchemaNode, bg as renderAccessibleChart, bh as requireResolvedWidget, bi as resolveTableWidgetData, bj as resolveWidget, bk as serializeManifest, bl as toJsonValue, bm as traverseSchema, bn as traverseSchemaManifest, bo as validateFormFields } from './browser-CKIUTmmB.js';
import { a0 as ComponentDefault, a1 as DefaultableComponentKind, q as UploadMimeInspector, s as UploadPolicy, a2 as SchemaComponentKind, a3 as SchemaVisibilityResolver, a4 as ResponsiveValue, a5 as SchemaColumnSpan, a6 as RenderSlotReference, a7 as CompiledSchemaComponent, a8 as SchemaComponentProperties, a9 as SchemaLayoutProperties, aa as CustomComponentProperties, ab as SchemaCollapseProperties, ac as SchemaPath, B as CompiledSchema, ad as SchemaBreakpoint, ae as RecordTypeSource, af as RecordTypeValue, ag as RuntimeTypeSource, ah as RuntimeTypeValue, ai as SchemaRenderSlots, aj as RegisteredAction, ak as ActionRegistration, al as WidgetServerHandles, am as WidgetColumnSpan, an as WidgetFilterDefinition, a as CompiledWidgetDefinition, ao as WidgetFamily, ap as WidgetDataContext, aq as TableWidgetData, ar as ContextTypeSources, as as OptionalRuntimeTypeValue, at as ChartWidgetData, au as ExtensionTypeId, av as CustomWidgetData, aw as StatsWidgetData, W as WidgetContext, ax as WidgetManifest, ay as ActionDefinition, az as ActionPresentationContext, aA as ActionResolvedState, aB as ActionManifest, aC as ActionResolvable, aD as ActionContext, aE as ActionFailureNotification, aF as ActionModalOptions, aG as ActionMount, aH as ActionRateLimit, aI as ActionSize, aJ as ActionSuccessNotification, aK as ActionKind, aL as ActionEngineOptions, c as ActionExecutionResult, b as ActionExecutionRequest, E as Effect, aM as ActionGroupItem, aN as ActionGroupManifest, aO as PageServerHandles, aP as PageComponentBody, aQ as PageResolvable, G as PageContext, aR as PageBreadcrumb, aS as PageNavigation, aT as PageRendererManifest, e as CompiledPageDefinition, aU as PageType, aV as PageNavigationInput, aW as PanelNavigationSeed, aX as PanelAccessContext, aY as PanelActorPresenter, aZ as CompiledPanelAuth, a_ as PanelAuthPageConfiguration, a$ as PanelAsset, b0 as PanelBootContext, b1 as PanelBranding, b2 as PanelComponentConfiguration, b3 as PanelDatabaseNotificationConfiguration, b4 as PanelDatabaseNotificationInboxOptions, b5 as PanelContentWidth, b6 as PanelSubNavigationPosition, b7 as PanelMiddleware, b8 as PanelNavigationGroup, b9 as PanelNavigationMode, Q as PanelRouteScope, V as PanelRouteRegistrar, ba as PanelPlugin, bb as PanelRegisteredDefinition, bc as ScopedRenderSlots, bd as RenderHook, be as PanelTheme, N as PanelAuthenticatedScope, bf as CompiledPanelTenancy, bg as PanelTenantBillingProvider, bh as PanelTenantMenuItem, bi as PanelUserMenuItem, C as CompiledPanelDefinition, bj as PanelLoginPageConfiguration, bk as PanelRegistrationPageConfiguration, bl as PanelPasswordResetPageConfiguration, bm as PanelEmailVerificationPageConfiguration, bn as PanelEmailChangeVerificationPageConfiguration, bo as PanelMultiFactorPageConfiguration, bp as PanelTenantIdentifier, bq as PanelTenancyOptions, br as PanelModelTenancyOptions, bs as PanelTokenTheme, bt as PluginCompatibility, bu as PanelPluginInstallation, bv as PanelRouteMethod, Z as PanelNotificationStore, bw as DashboardContext, bx as DashboardFilterSchema, by as DashboardNavigation, d as CompiledDashboardDefinition, bz as WidgetResourcePlacement, R as ResourceWidgetContext, bA as PanelTenantExecutionContext, bB as PanelNotificationScope, bC as TranslationReference, bD as EN_MESSAGES, bE as RegisteredTranslations, bF as TranslationArguments, bG as TranslationMessage } from './panel-locale-DtLeFjuC.js';
export { bH as AccessibleChartModel, bI as AccessibleChartRenderer, bJ as AccessibleChartRow, bK as ActionContract, bL as ActionItemResult, bM as ActionItemStatus, bN as ActionModalManifest, bO as ActionModalWidth, bP as ActionNode, bQ as ActionNotificationSender, bR as ActionPresentationDefinition, bS as ActionPresentationManifest, bT as ActionProperties, bU as ActionReadOnlyEntryManifest, bV as ActionReadOnlyInfolistManifest, bW as ActionReadOnlyPresentationManifest, bX as ActionRecordResolver, A as ActionTransaction, bY as ActionsRenderHook, bZ as ChartPoint, b_ as ChartSeries, b$ as ClientRegistryReference, c0 as CloseModalEffect, c1 as ColumnNode, c2 as ColumnProperties, c3 as CompiledNode, X as CompiledPanelRoute, g as CreateTemporaryUploadInput, c4 as DashboardManifest, D as DeleteTemporaryUploadInput, c5 as DownloadEffect, c6 as DuplicateRegistrationError, c7 as EntryNode, c8 as EntryProperties, c9 as ExportNode, ca as ExportProperties, cb as ExtensionRegistration, cc as ExtensionRegistry, cd as FieldNode, ce as FieldProperties, cf as FilterNode, cg as FilterProperties, F as FinalizedUploadResult, ch as FocusEffect, H as HoloAuth, ci as HoloAuthGuard, cj as ImportNode, ck as ImportProperties, cl as InvalidateTableEffect, cm as LayoutNode, cn as LayoutProperties, co as LocaleDirection, cp as MediaAttachmentBuilder, z as MediaAttachmentResult, M as MediaAttachmentTarget, cq as MissingRendererError, cr as NavigationNode, cs as NavigationProperties, ct as NodeKind, cu as NotificationActionReference, cv as NotificationNode, cw as NotificationProperties, P as PageManifest, cx as PageNode, cy as PageProperties, cz as PanelActiveTenantPersistence, cA as PanelAssetKind, cB as PanelAssetManifest, cC as PanelAuthContext, cD as PanelAuthorizationLayer, cE as PanelAuthorizationRequest, K as PanelBootstrap, cF as PanelDarkMode, cG as PanelDatabaseNotificationIdentity, cH as PanelDatabaseNotificationItem, _ as PanelDatabaseNotificationPage, cI as PanelDatabaseNotificationPayload, cJ as PanelDatabaseNotificationPlacement, cK as PanelErrorNotification, cL as PanelErrorNotificationConfiguration, cM as PanelGeneratorTemplate, cN as PanelGlobalSearchConfiguration, cO as PanelIconDefinition, cP as PanelIconPath, cQ as PanelLayoutConfiguration, cR as PanelLogoutPageConfiguration, cS as PanelManifest, cT as PanelMiddlewareContext, cU as PanelNode, cV as PanelNotificationAction, cW as PanelNotificationActionKind, cX as PanelNotificationAuthorization, cY as PanelNotificationBootstrap, cZ as PanelNotificationOperation, c_ as PanelNotificationPresentation, c$ as PanelNotificationRecipient, d0 as PanelNotificationRecipientResolver, d1 as PanelNotificationRecord, d2 as PanelNotificationStatus, d3 as PanelNotificationStorePage, d4 as PanelNotificationStorePagination, d5 as PanelNotificationStoreQuery, L as PanelOperation, d6 as PanelPackageModuleContribution, d7 as PanelPermissionSubject, d8 as PanelPluginAsset, d9 as PanelPluginBuilder, da as PanelPluginContribution, db as PanelPluginContributionDefinition, dc as PanelPluginIcon, dd as PanelProfilePageConfiguration, de as PanelProperties, df as PanelQueuedTenantContext, dg as PanelRendererFramework, dh as PanelRendererRegistration, di as PanelResolvedTenant, dj as PanelRouteHandler, dk as PanelRouteRegistry, dl as PanelRoutingConfiguration, dm as PanelRuntimeConfiguration, dn as PanelTenancyManifest, dp as PanelTenantBootstrap, $ as PanelTenantIdentity, dq as PanelTenantMembershipPage, dr as PanelTenantMembershipRequest, ds as PanelTenantPresentation, dt as PanelTenantPresentationInput, du as PanelTenantPresentationPage, dv as PanelTenantProfileOptions, dw as PanelTenantRegistrationOptions, dx as PanelTenantScopedQuery, dy as PanelThemeMode, dz as PanelTranslationContribution, dA as PanelTranslationKey, dB as PanelTranslator, dC as PanelsConfiguration, dD as PanelsRenderHook, dE as PluginCompatibilityError, dF as PluralCategory, dG as PluralTranslation, dH as PublicNode, dI as PublicSourceLocation, dJ as RedirectEffect, dK as RefreshEffect, dL as RegistryKind, dM as RenderSlotSource, h as ResolveTemporaryUploadInput, I as ResolvedPageData, dN as ResolvedPanelLocale, dO as ResolvedPanelManifest, Y as ResolvedPanelRoute, f as ResolvedWidget, dP as ResourceNode, dQ as ResourceProperties, dR as SCHEMA_BREAKPOINTS, S as SchemaComponentManifest, dS as SchemaComponentPatch, dT as SchemaJsonValue, dU as SchemaLeafKind, dV as SchemaLeafManifest, i as SchemaManifest, dW as SchemaNode, dX as SchemaProperties, dY as SchemaValueAtPath, dZ as ScopedRenderSlotManifest, d_ as ServerHandles, d$ as SourceLocation, j as StoredUploadDescriptor, e0 as SummaryNode, e1 as SummaryProperties, e2 as TRANSLATION_REFERENCE_KIND, e3 as TableNode, e4 as TableProperties, e5 as TablesRenderHook, e6 as TargetedSchemaPatch, T as TemporaryUploadDescriptor, k as TemporaryUploadServiceOptions, O as ToastEffect, e7 as TranslationCatalog, e8 as TranslationCatalogRegistry, e9 as TranslationCatalogSet, ea as TranslationCatalogSource, eb as TranslationLookup, ec as TranslationReplacementMap, ed as TranslationReplacementNames, ee as TranslationReplacementValue, ef as TranslationReplacements, U as UploadActorContext, l as UploadAuthorizationRequest, m as UploadAuthorizer, n as UploadEndpointBody, o as UploadEndpointRequest, p as UploadEndpointResponse, r as UploadOperation, t as UploadStorageAdapter, u as UploadStorageListPage, v as UploadStorageListRequest, eg as VersionRange, eh as WidgetFilterState, ei as WidgetLayout, ej as WidgetNode, ek as WidgetPolling, el as WidgetProperties, em as WidgetStat, en as WidgetsRenderHook, w as WriteTemporaryUploadInput, eo as actionPermissionReferences, ep as assertPluginCompatible, eq as assertUntranslatedStableKey, er as bindResourceActionOwner, es as canonicalLocale, et as compileRegisteredActions, eu as componentDefault, ev as createExtensionTypeId, ew as createPanelTranslator, ex as createSourceLocation, ey as createTranslationReference, ez as definePanelPlugin, eA as definePanelsConfig, eB as defineTranslationCatalog, eC as enCatalog, eD as exposeSourceLocation, eE as formatTranslation, eF as isTranslationReference, eG as normalizePanelLocaleConfiguration, eH as notificationActionReference, eI as rendererRegistryName, x as requestedLocales, y as resolvePanelLocale, eJ as resolveResourceNotificationAction, eK as resourceNotificationPermissionReferences } from './panel-locale-DtLeFjuC.js';
import { J as JsonObject, D as DiscoverableDefinition, d as DiscoverableBuilder, e as DiscoverableKind, b as JsonValue, f as TableQueryFilterDefinition, a as DiscoveryDirectories, H as HoloTableQuery, g as TableQueryDefinition, T as TableQueryState, h as TableQueryResult, i as TableRecordIdentifier, j as TableSelection, c as JsonPrimitive, k as TableFilterOperator, l as TableQueryFilter } from './types-sPSDwTY1.js';
export { A as AllTableQueryResult, C as ClientManifestValue, m as CursorTableQueryResult, n as DISCOVERABLE_KINDS, o as DISCOVERY_MARKER, p as HoloCursorPaginatedResult, q as HoloPaginatedResult, r as HoloPaginationMeta, s as HoloSimplePaginatedResult, t as HoloSimplePaginationMeta, u as JsonArray, P as PageTableQueryResult, S as SimpleTableQueryResult, v as TableAggregateKind, w as TablePaginationMode, x as TableQueryAggregateDefinition, y as TableQueryColumnDefinition, z as TableQueryScalar, B as TableQuerySort, E as TableSortDirection } from './types-sPSDwTY1.js';
...
export { E as ExecutePanelAuthOperationOptions, Q as ExecutePanelDatabaseNotificationOperationOptions, b as ExecutePanelTenantOperationOptions, c as ExecutePanelTenantSwitchOptions, S as GeneratedGlobalSearchInput, G as GeneratedResourceOperationInput, a as GeneratedResourceOperationResult, d as GeneratedUploadOperationInput, P as PANELS_CLEAN_TEMPORARY_UPLOADS_JOB, V as PageAccessError, f as PanelAuthOperation, g as PanelAuthOperationOutcome, W as PanelAuthPresentation, i as PanelDatabaseNotificationOperationResult, X as PanelNotificationRequestError, j as PanelRuntime, k as PanelRuntimeError, Y as PanelSubscriptionRequiredError, l as PanelTenantOperation, m as PanelTenantOperationError, Z as PanelTenantOperationFailure, n as PanelTenantOperationResult, o as PanelTenantSwitchResult, R as ResourceExecutor, _ as ResourceExecutorOptions, $ as ResourceInputError, a0 as ResourceMutationResult, a1 as ResourceNestedExecution, a2 as ResourceRecordNotFoundError, a3 as ResourceTableResult, T as TemporaryUploadService, U as UploadStoragePaginationError, a4 as authorizeGeneratedResourceNotification, p as bootPanel, a5 as compilePanelRoutes, a6 as compiledPanelRoutePath, q as createGeneratedResourcePage, r as createHoloUploadStorage, t as createTemporaryUploadService, u as executeGeneratedGlobalSearch, v as executeGeneratedResourceOperation, w as executeGeneratedUploadOperation, x as executePanelAuthOperation, y as executePanelDatabaseNotificationOperation, z as executePanelPipeline, B as executePanelRoute, C as executePanelTenantOperation, D as executePanelTenantSwitch, a7 as generatedResourcePageManifests, F as handleUploadEndpoint, H as panelAuthOperationStatus, a8 as panelAuthPresentation, I as panelErrorNotificationEffect, J as panelTenantOperationStatus, K as preparePageRoutes, a9 as resolveGeneratedResourceWidget, L as resolvePageData, M as resolvePanelRoute, N as runTemporaryUploadCleanupJob, O as toSchemaManifest } from './operation-Cbbo6pOm.js';
import { AuthUser } from '@holo-js/auth';
import { i as ResourceCompositionTypes, j as ResourceAttributes, a as ResourceModel, b as ResourceRecord, c as ResourceQuery, k as ResourceModelDefinition, l as ResourceInput, R as ResourceExecutionContext, m as ResourceGlobalSearch, n as ResourceLifecycle, o as ResourceNavigation, C as CompiledNestedResource, p as ResourcePersistence, q as ResourceAttribute, S as SingularResourceOptions, r as ResourceValidation, N as NestedResourceOptions, s as ResourceParentReference, d as ResourceDefinition, t as ResourceRecordFor } from './contracts-CijI6m1i.js';
export { e as ResourceAuthorization, u as ResourceCapabilities, v as ResourceClientManifest, f as ResourceIdentifier, w as ResourceOperation, g as ResourceParentRegistry, h as ResourceTransaction } from './contracts-CijI6m1i.js';
...
declare class TableWidgetBuilder<TActor = unknown, TTenant = unknown, TServices = unknown, TRecord extends object = object> extends WidgetBuilder<TableWidgetData, TActor, TTenant, TServices, TRecord> {
    constructor(id: string);
    table(resource: {
        compile(): {
            readonly id: string;
...
declare function defineResourceTableWidget<TRecordSource extends RecordTypeSource, TActorSource extends RuntimeTypeSource | undefined = undefined, TTenantSource extends RuntimeTypeSource | undefined = undefined, TServicesSource extends RuntimeTypeSource | undefined = undefined>(id: string, _sources: ResourceWidgetTypeSources<TRecordSource, TActorSource, TTenantSource, TServicesSource>): TableWidgetBuilder<OptionalRuntimeTypeValue<TActorSource>, OptionalRuntimeTypeValue<TTenantSource>, OptionalRuntimeTypeValue<TServicesSource>, Readonly<ResourceAttributes<RecordTypeValue<TRecordSource>>>>;
...
declare function resolveActionState<TRecord, TInput extends JsonObject, TActor, TTenant, TServices>(definition: Pick<ActionDefinition<TRecord, TInput, unknown, TActor, TTenant, TServices>, 'disabled' | 'label' | 'labelTranslationKey' | 'visible'>, context: ActionPresentationContext<TRecord, TInput, TActor, TTenant, TServices>): Promise<ActionResolvedState>;
...
declare class TableQueryExecutor<TQuery extends HoloTableQuery<TQuery, TRecord>, TRecord, TContext> {
    ...
    executeSelection<TRecordId extends TableRecordIdentifier>(state: TableQueryState, selection: TableSelection<TRecordId>, context: TContext, identifiersOnly?: boolean): Promise<readonly TRecord[]>;
...
declare class RelationManagerExecutor<TOwner, TRelated, TQuery, TInput extends Readonly<Record<string, unknown>>, TPivot extends Readonly<Record<string, unknown>>, TValue extends OptionValue, TActor extends object, TTenant> {
    ...
    resolveActionRecord(id: TValue, operation: RelationOperation, context: RelationManagerContext<TOwner, TActor, TTenant>): Promise<TRelated>;
    create(input: TInput, context: RelationManagerContext<TOwner, TActor, TTenant>): Promise<TRelated>;
...
declare class DashboardBuilder<TActor = unknown, TTenant = unknown, TServices = unknown> extends ConstructionBuilder<DashboardState<TActor, TTenant, TServices>, CompiledDashboardDefinition<TActor, TTenant, TServices>> implements DiscoverableBuilder<'page'> {
    ...
    persistFiltersInSession(enabled?: boolean): this;
    default(value?: boolean): this;
