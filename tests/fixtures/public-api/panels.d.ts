...
import { JsonValue, RuntimeTypeSource, ContextTypeSources, WidgetBuilder, RuntimeTypeValue, OptionalRuntimeTypeValue, DefaultPanelActor, DefaultPanelTenant, DefaultPanelServices, ChartWidgetData, JsonObject, PageTypeSources, PageBuilder, StatsWidgetData, TableWidgetBuilder, DiscoverableDefinition, definePage as definePage$1, definePanel as definePanel$1 } from '@holo-js/panels-core';
...
declare const defineTableWidget: {
